        ...
        Thread thread = new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    System.out.println("VISION_API req");
                   // Log.d("VISION_API", "sending request");
                    ...
                    System.out.println("error e 1 = " + e.getLocalizedMessage());
                    handler.post(new Runnable() {
                        @Override
                        public void run() {
                            onVisionApiListener.onError();
                    ...
                    System.out.println("error e 2 = " + e.getLocalizedMessage());
                    handler.post(new Runnable() {
                        @Override
                        public void run() {
                            onVisionApiListener.onError();
